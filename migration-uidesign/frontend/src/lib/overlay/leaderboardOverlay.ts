...
export const DEFAULT_LEADERBOARD_OVERLAY_SETTINGS: LeaderboardOverlaySettings = {
  ...
  matches: {
    color: "#FFFFFF",
    fontFamily: "var(--font-overlay-display), sans-serif",
    centerFontFamily: "var(--font-overlay-display), sans-serif",
    fontSize: 42,
    centerFontSize: 68,
    centerOffsetX: 0,
    centerOffsetY: 0,
...
export function normalizeLeaderboardOverlaySettings(value: unknown): LeaderboardOverlaySettings {
  ...
  return {
    ...
    leaderboard: {
      ...
      statOffsetX: safeNumber(leaderboard.statOffsetX, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.leaderboard.statOffsetX ?? 0, -900, 900),
      statOffsetY: safeNumber(leaderboard.statOffsetY, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.leaderboard.statOffsetY ?? 0, -500, 500),
    ...
    matches: {
      ...
      centerFontFamily: safeFont(matches.centerFontFamily, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.centerFontFamily ?? DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.fontFamily),
      centerOffsetX: safeNumber(matches.centerOffsetX, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.centerOffsetX ?? 0, -900, 900),
      centerOffsetY: safeNumber(matches.centerOffsetY, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.centerOffsetY ?? 0, -500, 500),
      teamAOffsetX: safeNumber(matches.teamAOffsetX, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamAOffsetX ?? 0, -900, 900),
      teamAOffsetY: safeNumber(matches.teamAOffsetY, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamAOffsetY ?? 0, -500, 500),
      teamBOffsetX: safeNumber(matches.teamBOffsetX, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamBOffsetX ?? 0, -900, 900),
      teamBOffsetY: safeNumber(matches.teamBOffsetY, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamBOffsetY ?? 0, -500, 500),
      teamAColumnGap: safeNumber(matches.teamAColumnGap, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamAColumnGap ?? DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.columnGap, 0, 140),
      teamBColumnGap: safeNumber(matches.teamBColumnGap, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.teamBColumnGap ?? DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.columnGap, 0, 140),
      fontSize: safeNumber(matches.fontSize, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.fontSize, 16, 120),
      centerFontSize: safeNumber(matches.centerFontSize, DEFAULT_LEADERBOARD_OVERLAY_SETTINGS.matches.centerFontSize ?? 68, 10, 300),
