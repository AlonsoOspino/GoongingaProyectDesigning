...
export type AnnouncementFace = "TOURNAMENT" | "CUSTOM";
export type ActiveAnnouncements = { enabled: boolean; mode?: AnnouncementFace; announcements: ActiveAnnouncementEntry[] };
export type AnnouncementSettings = { enabled: boolean; mode: AnnouncementFace; activeAnnouncementId: number | null; updatedAt: string };
