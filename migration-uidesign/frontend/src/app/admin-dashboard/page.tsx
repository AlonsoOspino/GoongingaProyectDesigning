...
const WRAPPED_IMAGE_FIELDS: Array<{ key: WrappedAssetKey; label: string }> = [
  { key: "damagePer10", label: "Best Damage / 10" },
  { key: "healingPer10", label: "Best Healing / 10" },
  { key: "killsPer10", label: "Best Kills / 10" },
  { key: "assistsPer10", label: "Best Assists / 10" },
  { key: "mitigationPer10", label: "Best Mitigation / 10" },
  { key: "lowestDeathsPer10", label: "Lowest Deaths / 10" },
  { key: "damageTotal", label: "Total Damage" },
  { key: "healingTotal", label: "Total Healing" },
  { key: "killsTotal", label: "Total Kills" },
  { key: "assistsTotal", label: "Total Assists" },
  { key: "mitigationTotal", label: "Total Mitigation" },
  { key: "performanceKda", label: "Best K/D Ratio" },
  { key: "kills", label: "Legacy Best Kills" },
  { key: "healing", label: "Legacy Best Healing" },
  { key: "assists", label: "Legacy Best Assists" },
  { key: "lowestDeaths", label: "Legacy Lowest Deaths" },
  { key: "mitigation", label: "Legacy Top Mitigation" },
  { key: "kda", label: "Legacy K/D Ratio" },
  { key: "totalDamage", label: "Legacy Total Damage" },
  { key: "totalHealing", label: "Legacy Total Healing" },
