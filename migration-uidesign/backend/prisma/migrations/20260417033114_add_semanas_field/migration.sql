...
INSERT INTO "new_Match" ("bestOf", "gameNumber", "id", "mapWinsTeamA", "mapWinsTeamB", "mapsAllowedByRound", "pointsTeamA", "pointsTeamB", "semana", "startDate", "status", "teamAId", "teamAready", "teamBId", "teamBready", "title", "tournamentId", "type") SELECT "bestOf", "gameNumber", "id", "mapWinsTeamA", "mapWinsTeamB", "mapsAllowedByRound", "pointsTeamA", "pointsTeamB", "semana", "startDate", "status", "teamAId", "teamAready", "teamBId", "teamBready", "title", "tournamentId", "type" FROM "Match";
DROP TABLE "Match";
