...
INSERT INTO "new_Match" ("bestOf", "gameNumber", "id", "mapResults", "mapWinsTeamA", "mapWinsTeamB", "mapsAllowedByRound", "pointsTeamA", "pointsTeamB", "semanas", "startDate", "status", "teamAId", "teamAready", "teamBId", "teamBready", "title", "tournamentId", "type") SELECT "bestOf", "gameNumber", "id", "mapResults", "mapWinsTeamA", "mapWinsTeamB", "mapsAllowedByRound", "pointsTeamA", "pointsTeamB", "semanas", "startDate", "status", "teamAId", "teamAready", "teamBId", "teamBready", "title", "tournamentId", "type" FROM "Match";
DROP TABLE "Match";
